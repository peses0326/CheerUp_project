...
/*            @Bean
            public CommandLineRunner demo(SayingRepository repository) {
                return (args) -> {
                    List<String> sayings = Arrays.asList("삶이 있는 한 희망은 있다  -키케로",
                            ...
                            "절대 어제를 후회하지 마라  인생은 오늘의 나 안에 있고 내일은 스스로 만드는 것이다 L론허바드" ,
                            "어리석은 자는 멀리서 행복을 찾고, 현명한 자는 자신의 발치에서 행복을 키워간다  -제임스 오펜하임" ,
                            "너무 소심하고 까다롭게 자신의 행동을 고민하지 말라  모든 인생은 실험이다  더많이 실험할수록 더나아진다  – 랄프 왈도 에머슨" ,
                            "한번의 실패와 영원한 실패를 혼동하지 마라  -F스콧 핏제랄드" ,
                            "내일은 내일의 태양이 뜬다" ,
                            "피할수 없으면 즐겨라 -로버트 엘리엇" ,
                            ...
                            "평생 살 것처럼 꿈을 꾸어라그리고 내일 죽을 것처럼 오늘을 살아라 – 제임스 딘" ,
                            "네 믿음은 네 생각이 된다  네 생각은  네 말이 된다 네말은 네 행동이 된다 네행동은 네 습관이된다  네 습관은 네 가치가 된다  네 가치는 네 운명이 된다 – 간디" ,
                            "일하는 시간과 노는 시간을 뚜렷이 구분하라  시간의 중요성을 이해하고 매순간을 즐겁게 보내고 유용하게 활용하라 그러면 젋은 날은 유쾌함으로 가득찰것이고 늙어서도 후회할 일이 적어질것이며 비록 가난할 때라도 인생을 아름답게 살아갈수있다  – 루이사 메이올콧" ,
                            "절대 포기하지 말라 당신이 되고 싶은 무언가가 있다면, 그에 대해 자부심을 가져라 당신 자신에게 기회를 주어라 스스로가 형편없다고 생각하지 말라 그래봐야 아무 것도 얻을 것이 없다 목표를 높이 세워라인생은 그렇게 살아야 한다  – 마이크 맥라렌" ,
                            "1퍼센트의 가능성, 그것이 나의 길이다 -나폴레옹" ,
                            "그대 자신의 영혼을 탐구하라다른 누구에게도 의지하지 말고 오직 그대 혼자의 힘으로 하라 그대의 여정에 다른 이들이 끼어들지 못하게 하라 이 길은 그대만의 길이요,  그대 혼자 가야할 길임을 명심하라  비록 다른 이들과 함께 걸을 수는 있으나 다른 그 어느 누구도 그대가 선택한 길을 대신 가줄 수 없음을 알라" ,
                            ...
                            "재산을 잃은 사람은 많이 잃은 것이고, 친구를 잃은 사람은 더많이 잃은 것이며, 용기를 잃은 사람은 모든것을 잃은 것이다 -세르반테스" ,
                                    ...
                                    "최고에 도달하려면 최저에서 시작하라 -P시루스" ,
                                    "내 비장의 무기는 아직 손안에 있다 그것은 희망이다 – 나폴레옹" ,
                                    "문제는 목적지에 얼마나 빨리 가느내가 아니라 그 목적지가 어디냐는 것이다 -메이벨 뉴컴버" ,
                                    "한 번 실패와 영원한 실패를 혼동하지 마라 -F스콧 핏제랄드" ,
